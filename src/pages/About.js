  ...
  return (
    <main className="about-page">
      <div className="about-page-hero">
        <h1>ABOUT US</h1>
        <p>Shaping the Future of Intelligent Packaging Since 2008</p>
      </div>
      <section className="about-page-content">
        <div className="about-page-container">
          <div className="about-page-main">
            ...
            <p>
              This transformation reflects our commitment to innovation, quality, and the evolving needs 
              of the sustainable packaging industry. We are not merely a manufacturer — we are a strategic 
              packaging partner equipped with a deep understanding of modern industrial requirements.
            </p>
            ...
            <h2>Why Choose Safe Plastomer</h2>
